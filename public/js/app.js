...
// Product Details Extraction Engine
function extractProductDetails(textItems) {
  ...
  // Strategy 1: Search for 'SKU' header token near left side
  let skuHeaderY = null;
  ...
  // Strategy 2: Fallback Regex Search for SKU patterns anywhere on page
...
async function renderCroppedPage(pdfPage, scale, cropX, cropY, cropW, cropH) {
  ...
  // Clear full canvas to prevent memory leak
  fullCanvas.width = 0;
  fullCanvas.height = 0;
